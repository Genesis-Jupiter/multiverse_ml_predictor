...
with st.form("timeline_form"):
    ...
    with col1:
        ...
        confidence_level = st.number_input("Confidence Level", value=0.8)
...
if submit:
    input_dict = {
        ...
        "lead_by_strange": lead_by_strange,
    ...
    try:
        ...
        ax2.legend(wedges, labels, title="Outcome", loc="center left", bbox_to_anchor=(1, 0.5), facecolor='#121212', labelcolor='white')
